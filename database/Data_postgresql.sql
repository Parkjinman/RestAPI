...
INSERT INTO CODE_GRP_TB ( CODE_GRP_ID, CODE_GRP_NM, CODE_GRP_VAL, CREATED_AT )
VALUES ( nextval('code_grp_seq'),'페이지 항목', 'pagePer', NOW() );
INSERT INTO CODE_TB ( CODE_ID, CODE_GRP_ID, CODE_NM, CODE_VAL, BIGO, ORD, CREATED_AT )
VALUES ( nextval('code_seq'), (SELECT CODE_GRP_ID FROM CODE_GRP_TB WHERE CODE_GRP_VAL = 'pagePer'), '10개', '10', NULL, '1', now() );
INSERT INTO CODE_TB ( CODE_ID, CODE_GRP_ID, CODE_NM, CODE_VAL, BIGO, ORD, CREATED_AT )
VALUES ( nextval('code_seq'), (SELECT CODE_GRP_ID FROM CODE_GRP_TB WHERE CODE_GRP_VAL = 'pagePer'), '20개', '20', NULL, '2', now() );
INSERT INTO CODE_TB ( CODE_ID, CODE_GRP_ID, CODE_NM, CODE_VAL, BIGO, ORD, CREATED_AT )
VALUES ( nextval('code_seq'), (SELECT CODE_GRP_ID FROM CODE_GRP_TB WHERE CODE_GRP_VAL = 'pagePer'), '50개', '50', NULL, '3', now() );
INSERT INTO CODE_TB ( CODE_ID, CODE_GRP_ID, CODE_NM, CODE_VAL, BIGO, ORD, CREATED_AT )
VALUES ( nextval('code_seq'), (SELECT CODE_GRP_ID FROM CODE_GRP_TB WHERE CODE_GRP_VAL = 'pagePer'), '100개', '100', NULL, '4', now() );
...
INSERT INTO public.menu_tb
(menu_id, menu_nm, menu_lv, parent_id, menu_url, ord, use_yn, menu_type, auth_role, main_yn, created_at)
VALUES(nextval('menu_seq'), 'FAQ 관리', 2, (select menu_id from menu_tb where menu_nm = '게시판 설정'), '/api/admin/faq', 2, 'Y', 'url', 'ADMIN', 'N', NOW());
INSERT INTO public.menu_tb
(menu_id, menu_nm, menu_lv, parent_id, menu_url, ord, use_yn, menu_type, auth_role, main_yn, created_at)
